...
function Navigationbar(props) {
  ...
  return (
    <>
      <Navbar collapseOnSelect expand="md" bg="dark" variant="dark" className='px-3 py-0 h-[3rem] navbarcolor'>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="d-flex justify-content-around h-[3rem] w-100 nav-options">
